...
const COLORS = ["var(--income-chart)", "var(--expense-chart)"]
...
const DashboardDataChart: React.FC<PropsType> = (props) => {
 ...
 if(isFetching){
  ...
  return (
    <Card className=" dark:border-border !pt-0 shadow-[0_4px_20px_-2px_rgba(20,20,20,0.04),0_2px_6px_-1px_rgba(20,20,20,0.02)] border border-black/5">
                  ...
                  formatter={(value, name) => {
                    ...
                    return [
                      <span key={name} style={{ color }}>
                        {formatCurrency(Number(value), {currency, showSign: true, compact: true, type: isExpense ? "EXPENSE" : "INCOME", })}
                      </span>,
