...
import { bdtToUsd,usdToBdt } from "@/lib/format-currency";
...
const TransactionForm = (props: { 
  ...
  }, [form, isEdit, transactionId,editData,isBDT]);
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 px-4">
                    ...
                    <label
                      ...
                      className={cn(
                        ...
                        field.value === _TRANSACTION_TYPE.INCOME &&
                          "border-primary dark:border-[#C6FF34]"
                      )}
                    >
                      <RadioGroupItem
                  ...
                  <FormControl>
                    <div className="relative">
                      <CurrencyInputField
                        ...
                        placeholder={isBDT ? "Tk 0.00" : "$0.00"}
                        prefix={isBDT ? "Tk " : "$"}
                      />
                    </div>
                  </FormControl>
          ...
          <div className="sticky bottom-0 bg-white dark:bg-background pb-2">
            <Button type="submit" className="w-full  dark:bg-[#C6FF34] dark:text-black" disabled={isScanning || isCreating || isUpdating}>
              {isEdit ? "Update" : "Save"}
            </Button>
          </div>
          {isLoading && (
