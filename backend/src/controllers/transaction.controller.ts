...
import { bulkDeleteTransactionService, bulkTransactionService, createTransactionService, deleteTransactionService, duplicateTransactionService, getAllTransactionService, getTransactionByIdService, scanRecieptService, updateTransactionService } from "../services/transaction.service";
...
export const getAllTransactionController = asyncHandler(async(req:Request,res:Response)=>{
    ...
    return res.status(HTTPSTATUS.OK).json({message:"Transaction fetched successfully",...result});
...
export const getTransactionByIdController = asyncHandler(async(req:Request,res:Response)=>{
    ...
    return res.status(HTTPSTATUS.OK).json({message:"Transaction feteched successfully",transaction});
});
...
export const duplicateTransactionController = asyncHandler(async(req:Request,res:Response)=>{
    ...
    return res.status(HTTPSTATUS.OK).json({message:"Transaction duplicated successfully",data:transaction});
});
...
export const bulkDeleteTransactionController = asyncHandler(async(req:Request,res:Response)=>{
    ...
    return res.status(HTTPSTATUS.OK).json({message:"Transaction deleted successfully",...result,});
});
...
export const bulkTransactionController = asyncHandler(async(req:Request,res:Response)=>{
    ...
    return res.status(HTTPSTATUS.OK).json({message:"Bulk Transaction inserted successfully",...result});
});


export const scanRecieptController = asyncHandler(async(req:Request,res:Response)=>{
    const file = req?.file;

    const result = await scanRecieptService(file);
