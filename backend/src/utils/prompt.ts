...
- Analyze the relationship between income, expenses, and savings rate. Evaluate if their savings rate is healthy (e.g., above 20% is excellent, under 10% needs adjustment). Provide structural advice on their cash allocation based on these numbers.
- Select the single most dominant expense category. Do not just state its percentage. Analyze the long-term impact of this category if left unmanaged, and offer a      practical, realistic micro-habit or cost-cutting strategy to optimize it next month.
